...
class TheathreViewController: UITableViewController {

    var data: [Movie] = []
    override func viewDidLoad() {
        super.viewDidLoad()

        theathreMoviesrequest.theathre{ (movies) in
            self.data = movies
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "theathre", for: indexPath) as! theathre
        ...
        cell.date.text = String(movie.date)
